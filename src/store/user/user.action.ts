...
export type SignUpStart = ActionWithPayload<USER_ACTION_TYPE.SIGN_UP_START, { displayName: string, email: string, password: string }>;
...
export const checkUserSession = withMatcher((): CheckUserSession => createAction(USER_ACTION_TYPE.CHECK_USER_SESSION));
...
export const signUpStart = withMatcher((displayName: string, email: string, password: string ): SignUpStart => 
    createAction(USER_ACTION_TYPE.SIGN_UP_START, { displayName, email, password }));
