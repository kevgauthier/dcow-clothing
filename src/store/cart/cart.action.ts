...
export const setIsCartOpen = withMatcher(
    (Boolean: boolean): SetIsCartOpen => createAction(CART_ACTION_TYPE.SET_IS_CART_OPEN, Boolean)
);


export const setCartItems = withMatcher(
  (cartItems: CartItem[]): SetCartItems => createAction(CART_ACTION_TYPE.SET_CART_ITEMS, cartItems)  
);
